  ...
  promises.forEach((el, ind) => {
    ...
    <div class="pc-container">
      <div class="pokemon-card">
        ...
        <div class="card_back">
          <div class="poke-stats-name">Vida: ${el.stats[0].base_stat}</div>
          ...
          <div class="poke-stats-name">Ataque: ${el.stats[1].base_stat}</div>
          <div class="poke-stats-bar"
          style="background: linear-gradient(to right, ${
            colors[pokemonTypes[0]]
          ...
          <div class="poke-stats-name">Defesa: ${el.stats[2].base_stat}</div>
          <div class="poke-stats-bar"
          style="background: linear-gradient(to right, ${
            colors[pokemonTypes[0]]
          ...
          <div class="poke-stats-name">Ataque Especial: ${
          ...
          <div class="poke-stats-name">Defesa Especial: ${
          ...
          <div class="poke-stats-name">Velocidade: ${el.stats[5].base_stat}</div>
          <div class="poke-stats-bar"
          style="background: linear-gradient(to right, ${
            colors[pokemonTypes[0]]
